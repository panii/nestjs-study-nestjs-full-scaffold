...
module.exports = {
  apps: [{
    ...
    error_file: "/tmp/pm2nestjs-full-scaffold_err.log", // error file path (default to $HOME/.pm2/logs/XXXerr.log)
    ...
    max_restarts: 30,                         // number of consecutive unstable restarts (less than 1sec interval or custom time via min_uptime) before your app is considered errored and stop being restarted
    watch: false,
